...
*********************************************************************************  */
	...
	opensql();
		$result = mysql_query("SELECT * FROM `Coupons_Titles` WHERE `text_id`='4'");
	...
	opensql();
		...
		$result			= mysql_query("SELECT * FROM `Coupons_Deals` WHERE `deal_status`='1' AND `deal_is_special`='2' ORDER BY `deal_position` ASC;");
	...
	<a href="deal.php?id=<?=$deal_id;?>">
	 <div class="previous_dealbox">
		<div class="predeal_head"><a href="/deal.php?id=<?=$deal_id;?>" style="text-decoration: none; color: rgb(95, 95, 95);"><?=$deal_name;?></a>
		</div></a><a href="deal.php?id=<?=$deal_id;?>">
